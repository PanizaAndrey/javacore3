package ru.panizaandrey.dz2.java;
...
//                } else if (line.matches("^/сменитьцену\\sтовар\\d+\\s\\d+$")) {
    ...
    private static void connect() throws Exception {
        try (InputStream input = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/ru/panizaandrey/dz2/resources/config.properties")) {
            prop.load(input);
